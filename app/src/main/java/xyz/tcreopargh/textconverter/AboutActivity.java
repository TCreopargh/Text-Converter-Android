                                    ...
                                    new AttributionPresenter.Builder(this)
                                        ...
                                        .addAttributions(
                                            ...
                                            new Attribution.Builder(
                                                ...
                                                .build(), new Attribution.Builder("Spots progress dialog")
                                                .setWebsite("https://github.com/d-max/spots-dialog")
                                                .addLicense(License.MIT)
                                                .addCopyrightNotice("Copyright © 2015 Maxim Dybarsky").build())
                                        .build();
